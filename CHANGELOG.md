...
| 包 | npm | CHANGELOG |
|---|---|---|
| `@meshbot/cli-agent` | [npm](https://www.npmjs.com/package/@meshbot/cli-agent) | [apps/cli-agent/CHANGELOG.md](apps/cli-agent/CHANGELOG.md) |
...
3. 合并 Version PR → `release.yml` 跑 `changeset publish`：
   - `cli-agent` / `server-agent` → npm publish + 自动 git tag
