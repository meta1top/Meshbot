...
| 圆角档 | **照搬落地页**（浏览器真实渲染三档对比后选定）：按钮/输入框 2px、卡片 6px、列表行 4px、头像等 `rounded-full` 不动 |
...
| `--radius-lg` | 8px | **4px** | 列表行、菜单面板 |
| `--radius-xl` | 11.2px | **6px** | 卡片、弹窗 |
| `--radius-2xl` / `3xl` / `4xl` | 14.4/17.6/20.8px | **6px** | 大卡收敛 |
| `--shell-radius` | 8px | **4px** | 壳结构件 |
