...
**Goal:** 建一个 meshbot skill（`.meshbot/skills/ota-reviews/`），每个 OTA 平台一个 Python 脚本，用 Scrapling 抓 2 个固定酒店的评论，归一化后去重落库；由 meshbot agent 手动触发。
...
> **关键约定（贯穿全程）**
> - 所有路径相对仓库根 `/Users/grant/Meta1/meshbot`。skill 目录 = `.meshbot/skills/ota-reviews/`，下称 `<SKILL>`。
...
**Files:**
- Create: `.meshbot/skills/ota-reviews/requirements.txt`
- Create: `.meshbot/skills/ota-reviews/scripts/__init__.py`（空文件）
- Create: `.meshbot/skills/ota-reviews/tests/__init__.py`（空文件）
- Create: `.meshbot/skills/ota-reviews/tests/fixtures/.gitkeep`（空文件）
- Create: `.meshbot/skills/ota-reviews/.gitignore`
- Create: `.meshbot/skills/ota-reviews/pytest.ini`

- [ ] **Step 1: 建目录与空文件**

```bash
cd /Users/grant/Meta1/meshbot
mkdir -p .meshbot/skills/ota-reviews/scripts .meshbot/skills/ota-reviews/tests/fixtures
touch .meshbot/skills/ota-reviews/scripts/__init__.py \
      .meshbot/skills/ota-reviews/tests/__init__.py \
      .meshbot/skills/ota-reviews/tests/fixtures/.gitkeep
```

- [ ] **Step 2: 写 requirements.txt**

`.meshbot/skills/ota-reviews/requirements.txt`:
```
scrapling>=0.2.9
pydantic>=2.6
pytest>=8.0
...
`.meshbot/skills/ota-reviews/.gitignore`:
```
.venv/
__pycache__/
*.pyc
...
`.meshbot/skills/ota-reviews/pytest.ini`:
```ini
[pytest]
markers =
...
```bash
cd /Users/grant/Meta1/meshbot/.meshbot/skills/ota-reviews
python3 -m venv .venv
. .venv/bin/activate
...
```bash
cd /Users/grant/Meta1/meshbot/.meshbot/skills/ota-reviews && . .venv/bin/activate
...
```bash
cd /Users/grant/Meta1/meshbot
git add .meshbot/skills/ota-reviews/requirements.txt \
        .meshbot/skills/ota-reviews/scripts/__init__.py \
        .meshbot/skills/ota-reviews/tests/__init__.py \
        .meshbot/skills/ota-reviews/tests/fixtures/.gitkeep \
        .meshbot/skills/ota-reviews/.gitignore \
        .meshbot/skills/ota-reviews/pytest.ini \
        .meshbot/skills/ota-reviews/scripts/SCRAPLING_API.md
...
**Files:**
- Create: `.meshbot/skills/ota-reviews/scripts/models.py`
- Test: `.meshbot/skills/ota-reviews/tests/test_models.py`
...
```bash
cd /Users/grant/Meta1/meshbot
git add .meshbot/skills/ota-reviews/scripts/models.py .meshbot/skills/ota-reviews/tests/test_models.py
...
**Files:**
- Create: `.meshbot/skills/ota-reviews/scripts/store.py`
- Test: `.meshbot/skills/ota-reviews/tests/test_store.py`
...
```bash
cd /Users/grant/Meta1/meshbot
git add .meshbot/skills/ota-reviews/scripts/store.py .meshbot/skills/ota-reviews/tests/test_store.py
...
**Files:**
- Modify: `.meshbot/skills/ota-reviews/scripts/store.py`（新增 `export_json`）
- Test: `.meshbot/skills/ota-reviews/tests/test_export.py`
...
```bash
cd /Users/grant/Meta1/meshbot
git add .meshbot/skills/ota-reviews/scripts/store.py .meshbot/skills/ota-reviews/tests/test_export.py
...
**Files:**
- Create: `.meshbot/skills/ota-reviews/targets.json`
- Create: `.meshbot/skills/ota-reviews/scripts/targets.py`
- Test: `.meshbot/skills/ota-reviews/tests/test_targets.py`

- [ ] **Step 1: 写 targets.json（先放 1 个已知目标 + 占位结构）**

`.meshbot/skills/ota-reviews/targets.json`:
```json
{
  "magellan-sutera": {
...
```bash
cd /Users/grant/Meta1/meshbot
git add .meshbot/skills/ota-reviews/targets.json \
        .meshbot/skills/ota-reviews/scripts/targets.py \
        .meshbot/skills/ota-reviews/tests/test_targets.py
...
**Files:**
- Create: `.meshbot/skills/ota-reviews/scripts/runner.py`
- Test: `.meshbot/skills/ota-reviews/tests/test_runner.py`
...
```bash
cd /Users/grant/Meta1/meshbot
git add .meshbot/skills/ota-reviews/scripts/runner.py .meshbot/skills/ota-reviews/tests/test_runner.py
...
**Files:**
- Create: `.meshbot/skills/ota-reviews/scripts/fetcher.py`
- Test: `.meshbot/skills/ota-reviews/tests/test_fetcher.py`
...
```bash
cd /Users/grant/Meta1/meshbot
git add .meshbot/skills/ota-reviews/scripts/fetcher.py .meshbot/skills/ota-reviews/tests/test_fetcher.py
...
**Files:**
- Create: `.meshbot/skills/ota-reviews/tests/fixtures/tripadvisor_sample.html`（抓取产物）
- Create: `.meshbot/skills/ota-reviews/scripts/tripadvisor.py`
- Test: `.meshbot/skills/ota-reviews/tests/test_tripadvisor.py`
...
```bash
cd /Users/grant/Meta1/meshbot
git add .meshbot/skills/ota-reviews/scripts/tripadvisor.py \
        .meshbot/skills/ota-reviews/tests/test_tripadvisor.py \
        .meshbot/skills/ota-reviews/tests/fixtures/tripadvisor_sample.html
...
```bash
cd /Users/grant/Meta1/meshbot/.meshbot/skills/ota-reviews/scripts && . ../.venv/bin/activate
...
git add .meshbot/skills/ota-reviews/scripts/tripadvisor.py \
        .meshbot/skills/ota-reviews/tests/test_tripadvisor.py \
        .meshbot/skills/ota-reviews/tests/test_live_tripadvisor.py
...
**Files:**
- Create: `.meshbot/skills/ota-reviews/tests/fixtures/trip_sample.html`（或 `trip_sample.json`，取决于走哪条路）
- Create: `.meshbot/skills/ota-reviews/scripts/trip.py`
- Test: `.meshbot/skills/ota-reviews/tests/test_trip.py`
...
- [ ] **Step 9: Commit**：
```bash
git add .meshbot/skills/ota-reviews/scripts/trip.py \
        .meshbot/skills/ota-reviews/tests/test_trip.py \
        .meshbot/skills/ota-reviews/tests/test_live_trip.py \
        .meshbot/skills/ota-reviews/tests/fixtures/trip_sample.* \
        .meshbot/skills/ota-reviews/targets.json
...
**Files:**
- Create: `.meshbot/skills/ota-reviews/SKILL.md`

- [ ] **Step 1: 写 SKILL.md**

`.meshbot/skills/ota-reviews/SKILL.md`:
```markdown
---
name: ota-reviews
...
```bash
git add .meshbot/skills/ota-reviews/SKILL.md
...
```bash
cd .meshbot/skills/ota-reviews/scripts && . ../.venv/bin/activate
...
```bash
cd /Users/grant/Meta1/meshbot
git status --short .meshbot/skills/ota-reviews/
```
...
```bash
git add .meshbot/skills/ota-reviews
...
- **形态/位置**（spec：meshbot skill `.meshbot/skills/ota-reviews/`，每平台一脚本）→ Task 1/8/10/11/12/14 覆盖。
